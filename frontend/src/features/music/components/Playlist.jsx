...
export default function Playlist() {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      <div className="shrink-0 mb-5 flex gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 rounded-2xl bg-gray-100 dark:bg-gray-900/50 border-none text-[13px] text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500/20 transition-all placeholder-gray-400"
          />
        </div>
        <button
      ...
      <div className="flex-1 max-h-[400px] md:max-h-none md:h-auto overflow-y-auto space-y-2 pr-1 scrollbar-custom">
        {filteredPlaylist.map((track) => {
          ...
          return (
            ...
            >
              {/* Ảnh Cover - Đã bỏ hiệu ứng nháy xanh */}
              ...
              <div className="flex-1 min-w-0">
                <h4 className={`text-[13.5px] font-bold truncate ${isActive ? 'text-emerald-700 dark:text-emerald-400' : 'text-gray-900 dark:text-gray-100'}`}>
                  {track.title}
                </h4>
                <p className={`text-[11px] font-bold truncate mt-0.5 ${isActive ? 'text-emerald-600/70 dark:text-emerald-500/60' : 'text-gray-500 dark:text-gray-400'}`}>
                  {track.artist}
                </p>
              </div>
              ...
              <div className="flex flex-col items-end gap-1">
                ...
                {/* Màu chữ Time - Đã chỉnh cho Mode sáng đậm hơn */}

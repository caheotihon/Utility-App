            ...
            <div className="relative w-full max-w-sm bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border border-black/5 dark:border-white/10 p-6 animate-in zoom-in-95 fade-in">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <input
                        ...
                        maxLength={60}
                        className="w-full px-4 py-3 rounded-2xl bg-gray-100 dark:bg-gray-800 border-none text-sm font-medium text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all"
                    />
                    <div className="flex gap-2">
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 py-3 rounded-2xl bg-gray-100 dark:bg-gray-800 text-sm font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all"
                        >
                            Huỷ
                        </button>
                        <button
